        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.popAlert)('success', 'Logged in successfully!'); // After 1secs redirect to home page
...
var buyBtn = document.querySelector('#buy-product'); // Login Button Event
