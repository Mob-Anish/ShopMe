        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.popAlert)('success', 'Account created successfully'); // After 1secs redirect to home page
          ...
          case 7:
            ...
            (0, _alert.popAlert)('error', _context2.t0.response.data.message);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alert.popAlert)('error', 'Error logging out! Try again.');
...
var stripe = Stripe('pk_test_51IhBWuDIZKozduyXk1W591tdkgL2vSaPxZANJTi4UTPIDgDCEU53H7ZV5BeX1bGnv0H43xbRWi8xJPxwekODSILA00SxfgtoLj');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3000/api/v1/orders/checkout-session/".concat(productId));
...
var buyBtn = document.querySelector('#buy-product');
var adminBtn = document.querySelector('.btn--admin'); // Search Form Event

if (searchForm) searchForm.addEventListener('submit', function (e) {
  e.preventDefault();
  console.log('er');
  var name = document.querySelector('.nav__search-input').value;
  (0, _search.search)(name);
}); // Login Button Event
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  (0, _login.login)(email, password); // login function
}); // SignUp Button Event
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _login.signUp)(name, email, password, passwordConfirm); // Signup function
}); // Logout Button Event

if (logoutBtn) logoutBtn.addEventListener('click', function (e) {
  e.preventDefault();
  (0, _login.logout)(); // login function
}); // Buy Button Event

if (buyBtn) buyBtn.addEventListener('click', function (e) {
  e.preventDefault();
  e.target.textContent = 'Processing ....';
  var productId = e.target.dataset.productId; // Getting id from btn data of buy now
